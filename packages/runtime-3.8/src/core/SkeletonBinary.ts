...
export class SkeletonBinary {
    ...
    readSkeletonData(binary: Uint8Array): SkeletonData {
        ...
        for (let i = 0; i < n; i++) {
            ...
            data.blendMode =
                SkeletonBinary.BlendModeValues[input.readInt(true)];
        ...
        for (let i = 0, nn; i < n; i++) {
            ...
            data.rotateMode =
                SkeletonBinary.RotateModeValues[input.readInt(true)];
            data.offsetRotation = input.readFloat();
                ...
                switch (timelineType) {
                    ...
                    case SkeletonBinary.SLOT_COLOR: {
                        ...
                        duration = Math.max(
                            duration,
                            timeline.frames[
                                (frameCount - 1) * ColorTimeline.ENTRIES
                            ]
                        );
                        break;
                    }
                    case SkeletonBinary.SLOT_TWO_COLOR: {
                        ...
                        duration = Math.max(
                            duration,
                            timeline.frames[
                                (frameCount - 1) * TwoColorTimeline.ENTRIES
                            ]
                        );
                        break;
                    }
                ...
                switch (timelineType) {
                    case SkeletonBinary.BONE_ROTATE: {
                        ...
                        duration = Math.max(
                            duration,
                            timeline.frames[
                                (frameCount - 1) * RotateTimeline.ENTRIES
                            ]
                        );
                        break;
                    }
                    ...
                    case SkeletonBinary.BONE_SHEAR: {
                        ...
                        duration = Math.max(
                            duration,
                            timeline.frames[
                                (frameCount - 1) * TranslateTimeline.ENTRIES
                            ]
                        );
                        break;
                    }
        ...
        if (drawOrderCount > 0) {
            ...
            for (let i = 0; i < drawOrderCount; i++) {
                ...
                for (let ii = 0; ii < offsetCount; ii++) {
                    ...
                    // Set changed items.
                    drawOrder[originalIndex + input.readInt(true)] =
                        originalIndex++;
                }
