// Type definitions for Pixi.js v3 and v4
// Modified for pixi-spine by ivan.popelyshev
...
declare module PIXI {
    ...
    export class TransformBase {
        ...
        position: Point;
        _dirtyLocal: number;
        _dirtyParentVersion: number;
        _versionLocal: number;

        //for gameofbombs fork 2.5d
        matrix2d: Matrix;
        version: number;
        isStatic: boolean;
        operMode: number;
    ...
    export class DisplayObject extends utils.EventEmitter implements interaction.InteractiveTarget {
        ...
        public displayObjectUpdateTransform: () => any;
