...
(function (Spine_1) {
    ...
    var Spine = (function (_super) {
        ...
        function Spine(spineData) {
            ...
            this.skeleton = new Spine_1.core.Skeleton(spineData);
            this.skeleton.updateWorldTransform();
            this.stateData = new Spine_1.core.AnimationStateData(spineData);
            this.state = new Spine_1.core.AnimationState(this.stateData);
            this.slotContainers = [];
            for (var i = 0, n = this.skeleton.slots.length; i < n; i++) {
                ...
                if (attachment instanceof Spine_1.core.RegionAttachment) {
                ...
                else if (attachment instanceof Spine_1.core.MeshAttachment) {
        ...
        Spine.prototype.createSprite = function (slot, attachment, defName) {
            ...
            sprite.rotation = attachment.rotation * Spine_1.core.MathUtils.degRad;
            sprite.anchor.x = 0.5;
            sprite.anchor.y = 0.5;
        ...
        Spine.prototype.hackTextureBySlotIndex = function (slotIndex, texture, size) {
            ...
            var region = attachment.region;
            if (texture) {
                region = new Spine_1.core.TextureRegion();
                region.texture = texture;
                region.size = size;
            }
