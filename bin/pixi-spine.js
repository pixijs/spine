            ...
            var SkeletonJson = (function () {
                ...
                SkeletonJson.prototype.readAttachment = function (map, skin, slotIndex, name) {
                    ...
                    switch (type) {
                        ...
                        case "linkedmesh": {
                            var path = this.getValue(map, "path", name);
                            var mesh_1 = this.attachmentLoader.newMeshAttachment(skin, name, path);
                            if (mesh_1 == null)
                                return null;
                            mesh_1.path = path;
                            var color = this.getValue(map, "color", null);
                            if (color != null)
                                mesh_1.color.setFromString(color);
                            var parent_4 = this.getValue(map, "parent", null);
                            if (parent_4 != null) {
                                mesh_1.inheritDeform = this.getValue(map, "deform", true);
                                this.linkedMeshes.push(new LinkedMesh(mesh_1, this.getValue(map, "skin", null), slotIndex, parent_4));
                                return mesh_1;
                            }
                            var uvs = map.uvs;
                            this.readVertices(map, mesh_1, uvs.length);
                            mesh_1.triangles = map.triangles;
                            mesh_1.regionUVs = uvs;
                            mesh_1.hullLength = this.getValue(map, "hull", 0) * 2;
                            return mesh_1;
                        }
                        case "path": {
...
(function (PIXI) {
    ...
    (function (spine) {
        function atlasParser() {
            return function (resource, next) {
                ...
                if (metadataAtlas && metadataAtlas.pages) {
                    var spineJsonParser = new spine.core.SkeletonJson(new spine.core.AtlasAttachmentLoader(metadataAtlas));
                ...
                this.add(resource.name + '_atlas', atlasPath, atlasOptions, function () {
                    new spine.core.TextureAtlas(this.xhr.responseText, adapter, function (spineAtlas) {
                        var spineJsonParser = new spine.core.SkeletonJson(new spine.core.AtlasAttachmentLoader(spineAtlas));
                        var skeletonData = spineJsonParser.readSkeletonData(resource.data);
                        resource.spineData = skeletonData;
        ...
        spine.imageLoaderAdapter = imageLoaderAdapter;
        ...
        spine.syncImageLoaderAdapter = syncImageLoaderAdapter;
    ...
    (function (spine) {
        ...
        var Spine = (function (_super) {
            ...
            function Spine(spineData) {
                ...
                this.skeleton = new spine.core.Skeleton(spineData);
                this.skeleton.updateWorldTransform();
                this.stateData = new spine.core.AnimationStateData(spineData);
                this.state = new spine.core.AnimationState(this.stateData);
                this.slotContainers = [];
            ...
            Spine.prototype.createSprite = function (slot, attachment, defName) {
                ...
                sprite.rotation = attachment.rotation * spine.core.MathUtils.degRad;
                sprite.anchor.x = 0.5;
                sprite.anchor.y = 0.5;
            ...
            Spine.prototype.hackTextureBySlotIndex = function (slotIndex, texture, size) {
                ...
                var region = attachment.region;
                if (texture) {
                    region = new spine.core.TextureRegion();
                    region.texture = texture;
                    region.size = size;
                }
